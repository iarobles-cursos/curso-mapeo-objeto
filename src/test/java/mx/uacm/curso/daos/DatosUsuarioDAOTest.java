...
public class DatosUsuarioDAOTest {

    private static EntityManager em;

    private static DatosUsuarioDAO datosUsuarioDAO;
    ...
    public static void inicializar() {
        ...
        datosUsuarioDAO = new DatosUsuarioDAOImpl(em);
    }
    ...
    @Test
    @Order(1)
    public void buscarDatosUsuarioTest() {

        System.out.println("buscar datos usuario por id");
        DatosUsuario d = datosUsuarioDAO.buscarPorId(1);
